...
public class ChristmasLocalTime implements SelectItemModelProperty<Boolean> {
    ...
    public static final SelectItemModelProperty.Type<ChristmasLocalTime, Boolean> TYPE = Type.create(MapCodec.unit(null), VALUE_CODEC);
